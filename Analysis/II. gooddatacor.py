def correlate(code):
    import pandas as pd
    data=pd.read_csv('ghcnm_out/Correlated Data/good50data/'+code)
    mon1=[]
    mon2=[]
    mon3=[]
    mon4=[]
...
if __name__ == "__main__":
    ...
    stations=pd.read_csv('ghcnm_out/stations/third_good_stations.csv')
    k=0
    corrlist1=[]
    corrlist2=[]
    corrlist3=[]
    ...
    os.chdir(path)
    path=os.getcwd()
    plotdf.to_csv('Thirdgooddatacorr.csv')